            ...
            <div class="modal-content mb-sm-3">
                ...
                <div class="modal-body">
                    <div class="bd-example">
                        <form action="{{route('add-cheap-ticket')}}" method="post" id="fareFinderForm">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="departure" id="flightsDeparture" class="form-control" placeholder="the airport you departure" aria-label="Departure" aria-describedby="basic-addon1" autocomplete="off" />
                                ...
                                <div class="col-md-4">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="arrival" id="filghtsArrival" class="form-control" placeholder="the airport you wish to arrive" aria-label="Arrive" aria-describedby="basic-addon1" autocomplete="off" />
                                        <div class="ajax-select">
                                ...
                                <div class="col-md-2">
                                    <button type="submit" id="ajaxAddCheapTicket" class="btn btn-outline-primary btn-md">Add</button>
